...
namespace RoslynTool.CsToLua
{
    internal class ClassInfo
    {
        ...
        internal void AddReference(INamedTypeSymbol refType)
        {
            ...
            if (null != refType && refType != SemanticInfo && SymbolTable.Instance.IsCs2DslSymbol(refType) && !refType.IsAnonymousType && !refType.IsImplicitClass && !refType.IsImplicitlyDeclared && refType.TypeKind != TypeKind.Delegate && refType.TypeKind != TypeKind.Dynamic && refType.TypeKind != TypeKind.Interface) {
