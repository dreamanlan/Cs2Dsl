...
namespace RoslynTool.CsToLua
{
    ...
    {
        public static ExitCode Process(string srcFile, IList<string> macros, IList<string> ignoredPath, IList<string> externPath, IDictionary<string, string> _refByNames, IDictionary<string, string> _refByPaths, bool enableInherit, bool enableLinq, bool outputResult)
        {
